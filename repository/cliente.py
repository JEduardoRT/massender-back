...
class Cliente(Base):
    ...
    membresia_id = Column(Integer,
                          ForeignKey('Membresia.membresia_id'),
                          nullable=False)
    tabla_precios_id = Column(Integer,
                              ForeignKey('TablaPrecios.tabla_precios_id'),
                              nullable=False)
    medio_pago_id = Column(Integer,
                           ForeignKey('MedioPago.medio_pago_id'),
                           nullable=False)
